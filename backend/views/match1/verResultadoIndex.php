...
<div class="match1-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>true,
            'columns' => require(__DIR__.'/_columnsVerPeriodo.php'),
            'toolbar'=> [
                ['content'=>
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de Asignaturas candidatas por Requerimiento',
                ...
                'after'=>BulkButtonWidget::widget([
                            'buttons'=>Html::a('<i class="glyphicon glyphicon-trash"></i>&nbsp; Borrar Seleccionados',
                                ...
                                [
                                    ...
                                    'data-confirm-message'=>'Está seguro que desea eliminar estos registros?'
                                ]),
                        ]).                        
