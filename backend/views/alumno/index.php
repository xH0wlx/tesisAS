...
<div class="alumno-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Crear nuevo Alumno', ['create'],
                    ['role'=>'modal-remote','title'=> 'Crear nuevo Alumno','class'=>'btn btn-success']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de Alumnos',
