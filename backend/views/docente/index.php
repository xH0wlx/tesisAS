...
<div class="docente-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Docente', ['create'],
                    ['role'=>'modal-remote','title'=> 'Crer nuevo Docente','class'=>'btn btn-success']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de Docentes',
