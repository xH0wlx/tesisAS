...
<div class="sede-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Nueva Sede', ['create'],
                    ['role'=>'modal-remote','title'=> 'Crear nueva Sede','class'=>'btn btn-success']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de Sedes',
