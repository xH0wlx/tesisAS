...
<div class="carrera-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Nueva Carrera', ['create'],
                    ['role'=>'modal-remote','title'=> 'Crear nueva Carrera','class'=>'btn btn-success']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de Carreras',
